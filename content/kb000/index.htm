...
<table id="parameters">
  <tr>
    ...
    <td><input data-kb-role="value" id="user-name" name="user-name" type="text" value="jcook"></td>
  </tr>
  <tr>
    <td><label for="host-fqdn">Fully-qualified domain name of host</label></td>
    <td><input data-kb-role="value" id="host-fqdn" name="host-fqdn" type="text" value="monocuit.co.uk"></td>
  </tr>
  <tr>
    <td><label for="host-name">Host name</label></td>
    <td><input data-kb-role="value" id="host-name" name="host-name" type="text" value="aleph"></td>
  </tr>
  <tr>
    <td><label for="putty-installation-directory">PuTTY installation directory</label></td>
    <td><input data-kb-role="value" id="putty-installation-directory" name="putty-installation-directory" type="text" value="%USERPROFILE%\PuTTY"></td>
  </tr>
  <tr>
    <td><label for="filezilla-installation-directory">FileZilla installation directory</label></td>
    <td><input data-kb-role="value" id="filezilla-installation-directory" name="filezilla-installation-directory" type="text" value="%USERPROFILE%\FileZilla-3.5.3"></td>
  </tr>
  <tr>
